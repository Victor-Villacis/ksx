...
pub use machine::{
    ...
    TemplateRow, UpdateProfile, UsbRow, VirtualPadRow, WinusbMutationView, WinusbPrepareSpec,
    WinusbReleaseSpec, WinusbView, CAVEAT_NOT_A_KEYBOARD, CLAIM_LEAD, INSTALL_BUS_REMEDY,
