...
pub use machine::{
    ...
    NewProfile, PadsSpawnSpec, PadsView, PanelHidCollectionRow, PanelInterfaceRow, PanelStatusRow,
    PanelStatusSpec, PanelStatusView, PresetRow, PresetsView, ProfileDetail, ProfilesView,
