...
pub use machine::{
    ...
    PanelBackupsSpec, PanelBackupsView, PanelByteDiffRow, PanelChartSpec, PanelChartView,
    PanelDriverCapabilities, PanelHardwareProfile, PanelHardwareProfileDeleteSpec,
    PanelHardwareProfileMutationView, PanelHardwareProfileSaveSpec, PanelHardwareProfilesView,
    PanelHardwareTerminal, PanelHidCollectionRow, PanelInterfaceRow, PanelKeyOption, PanelKeyValue,
    PanelProgramApplySpec, PanelProgramOutcome, PanelProgramPlanView, PanelProgramSpec,
    PanelRestoreApplySpec, PanelRestoreSpec, PanelRoutingAuthoritySpec, PanelRoutingGuard,
    PanelShiftState, PanelStatusRow, PanelStatusSpec, PanelStatusView, PanelTerminalDiffRow,
    PanelTerminalEdit, PanelTerminalRow, PresetRow, PresetsView, ProfileDetail, ProfilesView,
    PrunePlanView, RenamePreset, SetupDeviceRow, SetupSlotRow, SetupStep, SetupView, SpawnOffer,
    SpawnOption, TemplateRow, ThemeSpec, ThemeView, UpdateProfile, UsbRow, VirtualPadRow,
