...
/// Five constants are deliberately OFF the allowlist because they are
/// READ-side sentences that render into the page body and are never a
/// redirect target. They are named individually: if a sixth appears, that is a
