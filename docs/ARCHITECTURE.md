...
compatibility foundation; M8 now ships one HIDMaestro DualSense profile through
an authenticated elevated sibling; a later VIIPER lane provides software-defined virtual USB,
