  ...
  return h(
    ...
    h(
      ...
      h(
        ...
        h("span", { class: "crumb" }, "Game library"),
      ),
      h(
        "nav",
      ...
      h(
        ...
        h("nav", { class: "appmenu-panel", "aria-label": "Studio tools" },
          ...
          h("a", { href: "/profiles", "aria-current": "page" }, h("span", null, "Game library"), h("small", null, "Saved launch profiles")),
    ...
    h(
      ...
      h(
        "section",
        { class: "utility-hero", "aria-labelledby": "profiles-title" },
        h("div", null,
          h("p", { class: "eyebrow" }, "Studio tool"),
          h("h1", { id: "profiles-title" }, "Game library"),
          h("p", { class: "workflow-lede" }, "Keep launch targets, player counts, devices, and controller layouts together—and see broken paths before game time."),
        ),
        h("a", { class: "btn btn-primary", href: "/" }, "Go to Play"),
      ),
                    ...
                    h(
                      ...
                      h(
                        ...
                        h(
                          ...
                          "Use the device choices currently saved in guided setup",
                        ),
                        h(
                          "button",
      ...
      h(
        ...
        h(
          ...
          "edit any layout from Mapping. Built-in layouts stay protected, and ",
